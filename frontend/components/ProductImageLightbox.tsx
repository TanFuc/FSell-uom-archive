    ...
    <AnimatePresence>
      {isOpen && images.length > 0 && currentImage && (
        <motion.div
          ...
          className="fixed inset-0 z-[200] flex select-none flex-col bg-black/95 backdrop-blur-md"
          onClick={onClose}
        >
          {/* Top Control Bar */}
          <div
            className="relative z-10 flex h-16 w-full items-center justify-between px-4 text-white/80 sm:px-8"
          ...
          >
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <button
                ...
                className="hidden h-9 items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-3 text-[11px] font-medium tracking-wider text-white transition hover:bg-white/20 sm:flex"
              >
          ...
          >
            ...
            >
              ...
              <img
                ...
                alt={productName}
                draggable={false}
                className="max-h-[82vh] max-w-[90vw] select-none object-contain shadow-2xl drop-shadow-2xl"
              />
            </motion.div>
          </div>
              ...
              <div className="flex items-center gap-2 overflow-x-auto py-1">
                {images.map((img, idx) => (
                  <button
                    ...
                    className={cn(
                      'rounded-xs relative h-10 w-10 shrink-0 overflow-hidden border transition-all',
                      idx === currentIndex
