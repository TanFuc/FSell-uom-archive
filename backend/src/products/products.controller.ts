...
export class ProductsController {
  ...
  async findAllAdmin(@Query() query: QueryProductsDto, @CurrentUser() user: JwtPayload) {
  ...
  @ApiResponse({ status: 404, description: 'Product not found' })
  async hardDelete(@Param('id') id: string, @CurrentUser() user: JwtPayload) {
  ...
  async bulkDelete(@Body() dto: BulkDeleteDto, @CurrentUser() user: JwtPayload) {
  ...
  async bulkUpdate(@Body() dto: BulkUpdateDto, @CurrentUser() user: JwtPayload) {
  ...
  @ApiResponse({ status: 403, description: 'Forbidden - ADMIN only' })
  async bulkRestore(@Body() dto: BulkRestoreDto, @CurrentUser() user: JwtPayload) {
